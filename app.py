...
if uploaded_file:
    ...
    fun_themes = {
        "Rick and Morty": ["#A6EEE6", "#F0F035", "#44281D", "#E4A71B", "#8BCF21", "#FBFBFB"],
        ...
        "Common Side Effects": ["#FF00FF", "#00FF00", "#0000FF", "#FFFF00", "#00FFFF", "#FF0000"],
        "Tron": ["#2F5061", "#4291C7", "#D57FBE", "#E45D5C", "#FFAE91", "#F9DB57", "#FFFFD0"],
        "Inception": ["#EFAC3D", "#842650", "#69932B", "#5F2D7B", "#5C5D5E"],
        "Interstellar": ["#0B3D91", "#F2C45A", "#465362", "#A2BCE0", "#1E1E24"],
        "Severance": ["#F0F6F7", "#89AEC8", "#7B6727", "#4E452A", "#002C55"],
        "The Leftovers": ["#F2A78C", "#F2DCBB", "#B4B4BB", "#77708C", "#C997A2"],
        "Succession": ["#1C2541", "#3A506B", "#5BC0BE", "#6FFFE9", "#0B132B"],
        "The Rehearsal": ["#e0e1dd", "#778da9", "#415a77", "#1b263b", "#0d1b2a"],
        "Chernobyl": ["#D8FF00", "#E0FF33", "#333333", "#555555", "#D65050"],
